...
<Tabs>
  <TabItem value="grafana-ui" label="Grafana UI">
...
<Tabs>
  <TabItem value="yaml-provisioning" label="YAML Provisioning">
...
<details>
<summary><strong>Datasource returns 401</strong></summary>
...
<details>
<summary><strong>xTraces datasource: 'No traces found'</strong></summary>
...
<details>
<summary><strong>xLogs derived field TraceID not linking</strong></summary>
